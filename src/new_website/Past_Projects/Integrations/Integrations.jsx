    ...
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center pb-12">
            <h2 className="text-6xl text-black font-alliance font-bold">An Taste of the technology 
            {' '}
        <span className="relative whitespace-nowrap text-teal-800 font-alliance">
          ...
          <span className="relative text-teal-800 font-alliance">Our Students</span>
        </span>{''} can cover </h2>
          </div>
          {/* Logo animation */}
