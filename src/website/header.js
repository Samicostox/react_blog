...
const Header = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Optimize your workflow with our amazing tools and features. Make your development process smooth and efficient.'
    },
    {
      title: 'Secure your data',
      description: 'We prioritize your data security above everything. With advanced encryption, your data is safe with us.'
    },
  ];
  ...
  const slideTranslateX = activeSlide * -100;

  return (
    <div className="relative isolate pt-14">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40 overflow-hidden">
        <div 
