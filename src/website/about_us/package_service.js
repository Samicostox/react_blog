    ...
    <div>
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 pt-12 h-screen lg:sticky lg:top-14 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <img
              className="w-full h-full object-cover object-center rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10"
      ...
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 pt-12 h-screen lg:sticky lg:top-14 lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <img
              className="w-full h-full object-cover object-center rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10"
              src="https://res.cloudinary.com/dl2adjye7/image/upload/v1696278437/sebastiaan-stam-IkzP__YsL6s-unsplash_yf421q.jpg"
              alt=""
            />
          </div>
      ...
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 pt-12 h-screen lg:sticky lg:top-14 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <img
              className="w-full h-full object-cover object-center rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10"
              src="https://res.cloudinary.com/dl2adjye7/image/upload/v1696280564/eugene-chystiakov-lCllo-RwzRk-unsplash_fmefk2.jpg"
              alt=""
            />
          </div>
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
