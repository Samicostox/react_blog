  ...
  return (
    ...
    >
      {slides.map((slide, index) => (
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40 z-10">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto z-10">
                {slide.hiring && (
                  <div className="flex">
                    <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      <span className="font-semibold text-green-600 font-alliance font-bold">We’re hiring</span>
                      <span className="h-4 w-px bg-gray-900/10" aria-hidden="true" />
                      <a href="#" className="flex items-center gap-x-1">
                        <span className="absolute inset-0 font-alliance" aria-hidden="true" />
                        See open positions
                ...
                <p className="mt-6 text-lg leading-8 text-black-600 text-left font-alliance font-light">{slide.text}</p>
