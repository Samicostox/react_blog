          ...
          <div className="px-6 lg:px-0 lg:pt-4 ">
            <div className="mx-auto max-w-[1800px]">
              <div className="max-w-full pl-16 pr-16 ">
                ...
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl text-left w-full max-w-[600px]">
                  {" "}
                  {/* Added w-full to make title wider */}
                  Our Pool of Talents in the West Midlands
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600 text-left w-full">
                  {" "}
